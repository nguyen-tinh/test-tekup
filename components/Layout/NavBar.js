...
function NavBar() {
  return (
    <div className="bg-white h-32 container mx-auto">
      <div className=" text-primary items-center flex py-8 text-xs">
        {/* left  */}
        <div className="flex flex-1 space-x-5 items-center cursor-pointer">
